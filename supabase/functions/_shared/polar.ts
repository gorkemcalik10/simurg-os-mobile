...
export function normalizeExercise(input: Record<string, unknown>) {
  ...
  return {
    ...
    cardioLoadInterpretation: String(pick(trainingLoadPro, ["cardio_load_interpretation", "cardio-load-interpretation"]) || ""),
    muscleLoadInterpretation: String(pick(trainingLoadPro, ["muscle_load_interpretation", "muscle-load-interpretation"]) || ""),
    perceivedLoadInterpretation: String(pick(trainingLoadPro, ["perceived_load_interpretation", "perceived-load-interpretation"]) || ""),
