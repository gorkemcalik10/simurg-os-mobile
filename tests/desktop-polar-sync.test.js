...
run('changed production assets use matching cache versions', () => {
  ...
  assert.match(index, /sw\.js\?v=home-recovery-v2-1/);
  assert.match(worker, /SIMURG_CACHE = 'simurg-home-recovery-v2-1'/);
});
