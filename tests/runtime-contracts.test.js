...
run('signal model loads before dependent runtimes', () => {
  ...
  const activityPos = index.indexOf('simurg-activity-classification.js');
  ...
  assert.ok(activityPos >= 0 && activityPos < modelPos);
