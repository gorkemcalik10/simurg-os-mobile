(function(){
  ...
  function homeModel(){
    ...
    var activity=polar?{name:activityLabel(polar.workoutType||polar.activityType||'Polar Workout'),duration:polar.duration,date:polar.date,startTime:polar.startTime,cal:polar.activeCal,avgHR:polar.avgHR,maxHR:polar.maxHR,zones:polar.zones,source:'Polar Flow',polar:true}:
      apple?{name:activityLabel(apple.activityType||apple.workoutType||'Activity'),duration:apple.duration,date:apple.date,startTime:apple.startTime,cal:apple.activeCal,avgHR:apple.avgHR,maxHR:apple.maxHR,source:'Apple Watch'}:
